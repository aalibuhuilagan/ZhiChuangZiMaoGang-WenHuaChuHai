...
(function () {
    ...
    var pets = [
        { id: 'pet-ganmimi', label: '甘米米 Ganmimi', src: 'assets/ip/pet-ganmimi.png',
          lines: [
            ['甘工！出发！', 'Ganmi, let\'s go!'],
            ['欢迎来看海南的故事！', 'Welcome to Hainan\'s stories!'],
            ['要一起去文昌看火箭吗？', 'Wanna watch a rocket launch together?']
          ] },
        { id: 'pet-gualulu', label: '呱噜噜 Gualulu', src: 'assets/ip/pet-gualulu.png',
          lines: [
